...
const MovieIdPage = () => {
    ...
    dispatch({type: MovieAsctionEnum.pick, payload: movie})
            ...
            <div className={classes.movieContainer}>
                ...
                <div className={classes.movieInfo}>
                    ...
                    <div className={ classes.buttons }>
                        <ManageBtn onClick={ ()=>{
                            dispatch({type: ModalEnum.open, payload: true})
                            dispatch({type: ModalEnum.setContent, payload: 'edit'})
                        } }
                        >
                            Edit film
                        </ManageBtn>
                        <ManageBtn onClick={ ()=>{
                            dispatch({type: ModalEnum.open, payload: true})
                            dispatch({type: ModalEnum.setContent, payload: 'delete'})
